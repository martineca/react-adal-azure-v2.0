...
var AuthenticationContext = (function () {
    ...
    AuthenticationContext.prototype._getNavigateUrl = function (responseType, resource) {
        ...
        var urlNavigate = this.instance + tenant + '/oauth2/v2.0/authorize' + this._serialize(responseType, this.config, resource, scope) + this._addLibMetadata() +'&scope=openid%20email%20profile';
